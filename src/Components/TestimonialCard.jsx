...
export const AnimatedTestimonials = ({ testimonials, autoplay = true }) => {
  ...
  return (
    <div className="mx-auto max-w-sm px-4 pt-20 pb-10 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12">
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          >
            ...
            <p className=" text-gray-500">{testimonials[active].designation}</p>
            <motion.p className="mt-8 text-xl text-gray-500">
