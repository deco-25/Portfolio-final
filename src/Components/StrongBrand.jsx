...
const StrongBrand = () => {
  ...
  return (
    <div className="md:h-screen overflow-hidden max-md:py-8 relative flex gap-12 font-a text-white justify-center items-center bg-primaryBlack md:mt-[15vh] max-md:mt-[dvh] max-md:h-[100dvh]">
      <div
        id="brand-text"
