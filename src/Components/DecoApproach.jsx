...
const DecoApproach = () => {
  ...
  return (
    <div ref={mainRef} className="relative w-screen px-20 flex bg-[#f5f5f5]">
      <div className="h-screen w-screen flex items-center justify-between">
              ...
              <h3
                ...
                className={`${
                  index === currentStep
                    ...
                    : index < currentStep
                    ? "font-lato text-black/70"
                    : "font-lato text-black/40"
                }  text-5xl font-extrabold text-center transition-all duration-300`}
              >
                {step}
              </h3>
            ))}
        ...
        <div className="space-y-10 min-w-[20vw]">
          <div
            ref={numberRef}
            className="font-lato text-white text-9xl font-extrabold text-center text-outline"
          >
            {currentStep + 1}
          </div>
