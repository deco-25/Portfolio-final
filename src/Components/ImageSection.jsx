...
const mainTrigger = ScrollTrigger.create({
  ...
  return (
    <div ref={sectionRef} className="relative bg-primaryBlack">
      <div
        ref={overlayRef}
      ...
      >
        ...
        >
          <span className='max-w-fit'>{"0" + (activeSlide + 1)}/0{imageSectionData.length}</span>
        </div>
        ...
        <div style={{ writingMode: "vertical-rl", lineHeight: "1" }}
      ...
      <div className="relative">
        {imageSectionData.map((section, index) => (
          <div id={`slide-${index}`} key={index} className="min-h-[60vh] md:min-h-screen md:mb-32">
            <DistortedImage
              image={section.image}
            />
          </div>
